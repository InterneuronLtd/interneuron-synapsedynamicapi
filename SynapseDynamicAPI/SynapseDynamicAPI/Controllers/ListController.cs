...
namespace SynapseDynamicAPI.Controllers
{
    ...
    public class ListController : Controller
    {
        ...
        public ListController(IConfiguration Configration)
        {
        ...
        public string GetListDataByPost(string listId, [FromBody] string data)
        {
            ...
            DataServices.CheckBlacklistedKeywords(filtersToApplySB.ToString(), blackListedKeyWordsSection.GetSection("filter").Value);
        ...
        public string GetQuestionOptionCollection(string questionoptioncollection_id)
        {
            ...
            DataServices.CheckBlacklistedKeywords(questionoptioncollection_id, blackListedKeyWordsSection.GetSection("global").Value);
        ...
        public string GetContext(string defaultcontext, string defaultcontextfield, string value)
        {
            ...
            DataServices.CheckBlacklistedKeywords(defaultcontextfield, blackListedKeyWordsSection.GetSection("global").Value);
