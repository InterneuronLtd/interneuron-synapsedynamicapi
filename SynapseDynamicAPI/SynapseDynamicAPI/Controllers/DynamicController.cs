...
namespace SynapseDynamicAPI.Controllers
{
    ...
    public class DynamicController : Controller
    {
        ...
        public string GetList(string synapsenamespace, string synapseentityname, string returnsystemattributes, string orderby, string limit, string offset, string filter)
        {
            ...
            var blackListedKeyWordsSection = _configuration.GetSection("SynapseCore:Settings:BlackListRegex");
            
            DataServices.CheckBlacklistedKeywords(orderby, blackListedKeyWordsSection.GetSection("orderby").Value);
            DataServices.CheckBlacklistedKeywords(limit, blackListedKeyWordsSection.GetSection("limit").Value);
            DataServices.CheckBlacklistedKeywords(offset, blackListedKeyWordsSection.GetSection("limit").Value);
            DataServices.CheckBlacklistedKeywords(filter, blackListedKeyWordsSection.GetSection("filter").Value);
        ...
        public string GetListByPost(string synapsenamespace, string synapseentityname, string returnsystemattributes, string orderby, string limit, string offset, string filter, [FromBody] string data)
        {
            ...
            DataServices.CheckBlacklistedKeywords(filter, blackListedKeyWordsSection.GetSection("filter").Value);
            DataServices.CheckBlacklistedKeywords(filtersSQL, blackListedKeyWordsSection.GetSection("filter").Value);
            DataServices.CheckBlacklistedKeywords(orderBySting, blackListedKeyWordsSection.GetSection("orderby").Value);
            DataServices.CheckBlacklistedKeywords(limitString, blackListedKeyWordsSection.GetSection("limit").Value);
            DataServices.CheckBlacklistedKeywords(offsetString, blackListedKeyWordsSection.GetSection("limit").Value);
            ...
            string sql = $"SELECT * FROM (SELECT {fieldList}  FROM entitystorematerialised.{synapsenamespace}_{synapseentityname} WHERE 1=1 {filterString}) entview {filtersSQL} {orderBySting} {limitString} {offsetString};";
        ...
        public string GetObjectWithInsert(string synapsenamespace, string synapseentityname, string synapseattributename, string attributevalue, string keyvalue, string returnsystemattributes)
        {
            ...
            DataServices.CheckBlacklistedKeywords(synapsenamespace, blackListedKeyWordsSection.GetSection("global").Value);
            DataServices.CheckBlacklistedKeywords(synapseentityname, blackListedKeyWordsSection.GetSection("global").Value);
            DataServices.CheckBlacklistedKeywords(synapseattributename, blackListedKeyWordsSection.GetSection("global").Value);
        ...
        public string GetListByAttribute(string synapsenamespace, string synapseentityname, string synapseattributename, string attributevalue, string returnsystemattributes, string orderby, string limit, string offset, string filter)
        {
            ...
            DataServices.CheckBlacklistedKeywords(synapseattributename, blackListedKeyWordsSection.GetSection("global").Value);
            DataServices.CheckBlacklistedKeywords(filterString, blackListedKeyWordsSection.GetSection("filter").Value);
            DataServices.CheckBlacklistedKeywords(orderBySting, blackListedKeyWordsSection.GetSection("orderby").Value);
            DataServices.CheckBlacklistedKeywords(limitString, blackListedKeyWordsSection.GetSection("limit").Value);
            DataServices.CheckBlacklistedKeywords(offsetString, blackListedKeyWordsSection.GetSection("limit").Value);
        ...
        public IActionResult SynchronousPost([FromBody] string data)
        {
            ...
            if (request_dataversion.ToString() == lockobject.moduleDataVersion.versionid)
            {
                ...
                else
                {
                    ...
                    if (con != null)
                    {
                        try
                        {
                            ...
                            if (request_dataversion.ToString() == lockobject.moduleDataVersion.versionid)
                            {
                                ...
                                lockobject.moduleDataVersion.createdby = GetUserIdFromRequest();
                                lockobject.createdby = lockobject.moduleDataVersion.createdby;
                            ...
                            else
                            {
                                ...
                                var response = new BadRequestObjectResult(string.Format("oldversion-T2: Data version is old, Please refresh your application serverversion:{0}", JsonConvert.SerializeObject(lockobject)));
                                return response;
                            }
                        }
                        finally
                    ...
                    else
                    {
                        ...
                        var response = new BadRequestObjectResult(string.Format("otherprocesswriting: Data version is old, Please refresh your application serverversion:{0}", JsonConvert.SerializeObject(lockobject)));
                        return response;
                    }
                }
            }
            ...
            {
                // stale version - request a refresh to acquire latest data and version
                var response = new BadRequestObjectResult(string.Format("oldversion-T1: Data version is old, Please refresh your application serverversion:{0}", JsonConvert.SerializeObject(lockobject)));
        ...
        [HttpGet]
        [Route("[action]/{personId?}/{moduleName?}")]
        public string GetSynchronousPostVersion(string personId, string moduleName)
        {
            if (string.IsNullOrEmpty(personId) || string.IsNullOrEmpty(moduleName))
                return "";
            else
                  ...
                  //second check -it is possible two or more threads have arrived to this second check if lock object did not exist at first check
                    ...
                    if (lockobject is null) // The second (double) check
                    {
                        ...
                        if (versionrecord is null)
                        {
                            ...
                            versionrecord.createdby = this.GetUserIdFromRequest();
                        ...
                        lockobject.createdby = versionrecord.createdby;
        ...
        private string DeleteObjectByAttributeHandler(string synapsenamespace, string synapseentityname, string synapseattributename, string attributevalue, dynamic connectionObj = null, dynamic transactionObj = null)
        {
            ...
            string sql = "UPDATE entitystore." + synapsenamespace + "_" + synapseentityname + " SET _recordstatus = 2, _deletedby = '" + GetUserIdFromRequest() + "', _deleteddate = now() WHERE _recordstatus = 1 AND " + synapseattributename + " = @p_attributevalue";
            var paramList = new List<KeyValuePair<string, object>>() {
        ...
        private string DeleteByIdHandler(string synapsenamespace, string synapseentityname, string id, dynamic connectionObj = null, dynamic transactionObj = null)
        {
            ...
            string sql = "UPDATE entitystore." + synapsenamespace + "_" + synapseentityname + " SET _recordstatus = 2, _deletedby = '" + GetUserIdFromRequest() + "', _deleteddate = now()  WHERE " + keyAttribute + " = @p_keyAttributeValue;";
            var paramList = new List<KeyValuePair<string, object>>() {
                     new KeyValuePair<string, object>("p_keyAttributeValue", id)
                };
            DataServices.executeSQLStatement(sql, paramList, existingCon: connectionObj);
