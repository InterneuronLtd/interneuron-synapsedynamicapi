...
namespace SynapseDynamicAPI.Controllers
{
    ...
    public class BaseViewController : Controller
    {
        ...
        public BaseViewController(IConfiguration Configration)
        {
        ...
        public string GetBaseViewList(string baseviewname, string orderby, string limit, string offset, string filter)
        {
            ...
            DataServices.CheckBlacklistedKeywords(baseviewname, blackListedKeyWordsSection.GetSection("global").Value);
        ...
        public string GetBaseViewListByPost(string baseviewname, string orderby, string limit, string offset, string filter, [FromBody] string data)
        {
            ...
            DataServices.CheckBlacklistedKeywords(selectstatement, blackListedKeyWordsSection.GetSection("select").Value);
            DataServices.CheckBlacklistedKeywords(baseviewname, blackListedKeyWordsSection.GetSection("global").Value);
            DataServices.CheckBlacklistedKeywords(filterString, blackListedKeyWordsSection.GetSection("filter").Value);
            DataServices.CheckBlacklistedKeywords(orderBySting, blackListedKeyWordsSection.GetSection("orderby").Value);
            DataServices.CheckBlacklistedKeywords(limitString, blackListedKeyWordsSection.GetSection("limit").Value);
            ...
            DataServices.CheckBlacklistedKeywords(ordergroupbystatement, blackListedKeyWordsSection.GetSection("orderby").Value);
