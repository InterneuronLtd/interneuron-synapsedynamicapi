...
namespace SynapseDynamicAPI.Services
{
    public class DataServices
    {
        ...
        public static void executeSQLStatement(string sql, List<KeyValuePair<string, object>> parameters = null, string databaseName = "connectionString_SynapseDataStore", NpgsqlConnection existingCon = null)
        {
            ...
            {
                if (con != null && existingCon == null)
                {
                    con.Close();
                    con.Dispose();
                }
                throw new InterneuronDBException(ex);
            }
        ...
        //public static void CheckBlacklistedKeywords(string statement, string[] blackListedKeyWords)
        //{
        //    if (!string.IsNullOrEmpty(statement))
        //    {
        //        var tempStatement = statement.ToLower().TrimStart();
        //        if (blackListedKeyWords.Any(x => tempStatement.Contains(x)))
        //        {
        //            throw new InterneuronBusinessException(400, "Invalid Sql Keyword");
        //        }
        //        if (tempStatement.StartsWith("select") && tempStatement.Contains("()"))
        //        {
        //            throw new InterneuronBusinessException(400, "Invalid Sql Keyword");
        //        }
        //    }
